          ...
          <div class="col-md-3">
            ...
            <div class="member" data-aos="fade-up" data-aos-delay="100">
              <div class="member-img">
                <?php if(file_exists('./public/uploads/doctors/'.$doctor['image'])){?>
                  <img width="100" height="100" src="<?php echo base_url('public/uploads/doctors/'.$doctor['image'])?>" class="img-fluid" alt="">
              ...
              <div class="member-info">
                ...
                <span><?php echo $doctor['designation'];?></span>
                <span><?php echo $doctor['description'];?></span>
              </div>
            </div>
          </div>
                </div>
    ...
    <section id="contact" class="contact">
      ...
      <div class="container">
        ...
        <div class="row mt-5">
          ...
          <div class="col-lg-6">
          <form action="<?php echo base_url('appointment/store');?>" method="post">
              <div class="row">
