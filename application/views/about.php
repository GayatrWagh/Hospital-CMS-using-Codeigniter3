    ...
    <section id="about" class="about">
      <div class="container" data-aos="fade-up">
        ...
        <div class="section-title">
          ...
          <p><?php echo $about['h_description'];?></p>
        </div>

        <div class="row">
          <div class="col-lg-6" data-aos="fade-right">
          <?php if(file_exists('./public/uploads/about/'.$about['image'])){?>
                <img src="<?php echo base_url('public/uploads/about/'.$about['image'])?>" alt="" class="img-fluid">

                  <?php } ?>
            
          </div>
          <div class="col-lg-6 pt-4 pt-lg-0 content" data-aos="fade-left">
            <h3><?php echo $about['small_description'];?></h3>
            <p>
            <?php echo $about['large_description'];?>
            </p>
